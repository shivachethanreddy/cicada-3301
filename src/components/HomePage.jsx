      ...
      {/* Main content */}
      <div className="relative z-40 flex flex-col items-center text-center px-4 pt-8 md:pt-16 border-none min-h-screen w-full overflow-y-auto custom-scrollbar">
        <div className="w-full max-w-7xl mx-auto mb-20 max-h-[90vh] overflow-y-auto hide-scrollbar">
          <WordReveal
            text="CICADA 3301"
            className="text-4xl sm:text-6xl md:text-8xl lg:text-10xl font-bold neonGlitch mb-4 md:mb-6 break-words px-4"
            delay={350}
          />
          ...
          <div
            ...
            className="w-full max-w-4xl mx-auto mb-6 overflow-hidden border-2 border-red-500 bg-red-900/30 rounded-lg shadow-lg shadow-red-500/40 cursor-pointer hover:bg-red-800/40 transition-all duration-300"
          >
            <div className="whitespace-nowrap animate-marquee py-3 text-red-400 font-bold text-sm sm:text-lg tracking-wider">
              ⚠ WARNING: ZER0SECURE CTF 2026 REGISTRATIONS OPEN NOW — APRIL 17–18 | ₹13 LAKHS+ PRIZE POOL | CLICK HERE TO REGISTER ⚠
            </div>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto animate-fadeInUp text-center bg-black/70 p-6 sm:p-8 rounded-xl border border-green-600 shadow-xl shadow-green-500/30 backdrop-blur-sm relative">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 neonGlitch">
            ZeroSecure CTF 2026
          </h2>

          <div className="text-left space-y-6 h-[82vh] overflow-y-auto pr-2 custom-scrollbar pb-40">
            <div className="space-y-2">
              <WordReveal
                text=" Samavarthan 2k26 – Fusion 15th Edition Presents ZeroSecure"
                className="text-xl sm:text-2xl font-bold text-green-300"
                delay={300}
              />
              <p>📍 MVSR Engineering College, Hyderabad</p>
              <p>📅 Date: 17th – 18th April 2026</p>
              <p>⏱ Duration: 24 Hours</p>
              <p>👥 Team Size: 2 – 3 Members</p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">🎯 Event Description:</h4>
              <p>
                ZeroSecure is a 24-hour Capture The Flag cybersecurity competition
                where underground minds rise to solve real-world hacking challenges.
              </p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">🔐 Domains:</h4>
            ...
            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">💻 Participation Modes:</h4>
              <p>ONLINE and OFFLINE available</p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">💰 Registration Fee:</h4>
              <p>Online: ₹200 per team</p>
              <p>Offline: ₹400 per team</p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">🏆 Prize Pool:</h4>
              <p className="text-yellow-300 font-semibold">Worth ₹13 Lakhs+</p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">👨‍🏫 Faculty Coordinators:</h4>
              <p>Dr. Rajesh Kulkarni</p>
              <p>Dr. Akhil Khare</p>
              <p>Dr. Sirisha Daggubati</p>
              <p>Dr. M.V.R Jyothishree</p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">👥 Student Coordinators:</h4>
              <p>Aniketh Ch – 8309012359</p>
              <p>S Sai Puneeth – 9515842305</p>
              <p>Satwika A – 7013863875</p>
            </div>

            <div className="space-y-2">
              <h4 className="text-lg sm:text-xl font-bold text-green-300">🌐 Links:</h4>
              <a
                href="https://www.zerosecurectf.online"
                target="_blank"
                rel="noopener noreferrer"
                className="block text-green-300 underline hover:text-green-200"
              >
                https://www.zerosecurectf.online
              </a>
              <a
                href="https://unstop.com/competitions/zerosecure-ctf-mvsr-engineering-college-mvsrec-hyderabad-1661662"
                target="_blank"
                rel="noopener noreferrer"
                className="block text-green-300 underline hover:text-green-200"
              >
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6">
                <p className="mb-2 sm:mb-0">
                  Scan the QR code from the poster to register now.
                </p>
                <div className="flex flex-col items-center mt-2 sm:mt-0">
                  <span className="text-xs text-green-300 mb-1">Scan to Register</span>
                  <img
                    src={eventQr}
                    alt="ZeroSecure Registration QR"
                    className="w-28 h-28 sm:w-32 sm:h-32 rounded bg-white p-1 border border-green-400 shadow-md"
                  />
                </div>
              </div>
            </div>
